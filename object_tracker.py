...
video_path   = "./IMAGES/cars_video_2.mp4"
yolo = Load_Yolo_model()
Object_tracking(yolo, video_path, "cars_video_2_tracking_.mp4", input_size=YOLO_INPUT_SIZE, show=True, score_threshold=0.4, iou_threshold=0.5, rectangle_colors=(255,0,0), Track_only = ["car"])
