...
TRAIN_CLASSES               = './model_data/custom_dataset_names.txt'
# TRAIN_ANNOT_PATH            = "mnist/mnist_train.txt"
# TRAIN_ANNOT_PATH            = 'model_data/coco/train2017.txt'
TRAIN_ANNOT_PATH            = './model_data/custom_dataset_train.txt'
TRAIN_LOGDIR                = "log"
...
# TEST_ANNOT_PATH             = 'model_data/coco/val2017.txt'
TEST_ANNOT_PATH             = './model_data/custom_dataset_test.txt'
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
# TEST_INPUT_SIZE             = 512
TEST_DATA_AUG               = False
