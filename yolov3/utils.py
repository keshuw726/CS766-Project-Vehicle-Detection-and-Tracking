...
def detect_video(Yolo, video_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.3, rectangle_colors=''):
    times, times_2 = [], []
    vid = cv2.VideoCapture(video_path)
